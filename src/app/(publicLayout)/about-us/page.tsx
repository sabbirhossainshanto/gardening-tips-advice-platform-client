        ...
        <div className="space-y-10 mt-20 lg:mt-0">
          ...
          <div className="text-center">
            ...
            <div title="Future Plans">
              <h1>
                Our platform aims to introduce more interactive features such as
                real-time garden monitoring, plant disease identification, and
                more gardening tools. Stay tuned for exciting updates!
              </h1>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <div>
            <Card>
              ...
              <CardBody>
                <h1>
                  Tom is an avid gardener and landscape designer who believes in
                  the healing power of nature. With a background in
                  environmental science, he specializes in creating eco-friendly
                  garden designs that promote biodiversity. His mission is to
                  inspire others to connect with nature through gardening.
                </h1>
              </CardBody>
            </Card>
          </div>
            ...
            <Card>
              ...
              <CardBody>
                <h1>
                  ...
                  contributed articles to several gardening magazines and loves
                  sharing tips on container gardening and indoor plants. In her
                  free time, she enjoys visiting botanical gardens and learning
                  about rare plant species.
                </h1>
              </CardBody>
            </Card>
          </div>
